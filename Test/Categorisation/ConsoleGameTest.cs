...
namespace Test
{
    ...
    class ConsoleGameTest
    {
        ...
        public void when_making_an_invalid_move_then_correct_failure_message_is_displayed()
        {
            ...
            try
            {
                string message = consoleGame.Change("right");
            }
            catch(Exception e)
            {
